...
import hu.prf.szavazaskezelo.beans.PollAnswersFacade;
...
@RequestScoped
public class PollAnswersController implements Serializable {

    private PollAnswers current;
    private DataModel items = null;
    @EJB
    private hu.prf.szavazaskezelo.beans.PollAnswersFacade ejbFacade;
    ...
    public PollAnswers getSelected() {
        if (poll_answer_id != null){
            current = (PollAnswers) getFacade().find(Long.parseLong(poll_answer_id));
        }
        if (current == null) {
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PollAnswersUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PollAnswersDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    @FacesConverter(forClass = PollAnswers.class)
    public static class PollAnswersControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            PollAnswersController controller = (PollAnswersController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "pollAnswersController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof PollAnswers) {
                PollAnswers o = (PollAnswers) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + PollAnswers.class.getName());
            }
        }
